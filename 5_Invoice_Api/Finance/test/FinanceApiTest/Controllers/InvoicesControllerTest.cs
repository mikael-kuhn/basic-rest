...
namespace FinanceApiTest.Controllers
{
    ...
    public sealed class InvoicesControllerTest
    {
        ...
        private readonly Mock<IModelDomainMapper<GetMinimalInvoice, Domain.Invoice>> getMinimalInvoiceMapperMock;
        ...
        public InvoicesControllerTest()
        {
            ...
            getMinimalInvoiceMapperMock = new Mock<IModelDomainMapper<GetMinimalInvoice, Domain.Invoice>>();

            testSubject = new InvoicesController(invoiceRepositoryMock.Object,
            getInvoiceMapperMock.Object,
            updateInvoiceMapperMock.Object,
            getMinimalInvoiceMapperMock.Object);
        ...
        [Fact]
        public void Get_should_return_a_list_of_invoices()
        {
            // Act
            var response = (OkObjectResult)testSubject.Get();

            // Assert
            Assert.NotNull(response.Value as IEnumerable<GetInvoice>);
        }

        [Fact]
        public void Get_should_return_PreferenceApplied()
        {
            // Assert
            testSubject.Request.Headers.Add("Prefer", "return=representation");

            // Act
            testSubject.Get();

            // Assert
            Assert.True(testSubject.Response.Headers["Preference-Applied"].Contains("return=representation"));
        }

        [Fact]
        public void Get_should_not_return_PreferenceApplied()
        {
            // Assert
            testSubject.Request.Headers.Add("Prefer", "return=x");

            // Act
            testSubject.Get();

            // Assert
            Assert.False(testSubject.Response.Headers.ContainsKey("Preference-Applied"));
        }

        [Fact]
        public void Get_should_return_Vary()
        {
            // Assert
            testSubject.Request.Headers.Add("Prefer", "return=representation");
            ...
            // Assert
            Assert.True(testSubject.Response.Headers.ContainsKey("Vary"));
        }

        [Fact]
        public void Get_should_return_GetMinimalInvoice()
        {
            // Assert
            testSubject.Request.Headers.Add("Prefer", "return=minimal");

            // Act
            var response = (OkObjectResult)testSubject.Get();

            // Assert
            Assert.NotNull(response.Value as IEnumerable<GetMinimalInvoice>);
        }
