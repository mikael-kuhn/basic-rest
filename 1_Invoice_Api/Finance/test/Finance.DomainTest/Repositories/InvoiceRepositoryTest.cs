...
namespace Finance.DomainTest.Repositories
{
    ...
    public sealed class InvoiceRepositoryTest
    {
        ...
        {
            // Arrange
            var expected = new Invoice("1000", DateTimeOffset.Now.Date, DateTimeOffset.Now.Date,
        ...
        {
            // Arrange
            var expected = new Invoice("unknown", DateTimeOffset.Now.Date, DateTimeOffset.Now.Date,
        ...
        {
            // Arrange
            var instance = new Invoice("1001", DateTimeOffset.Now.Date, DateTimeOffset.Now.Date,
                new InvoiceCustomer("Customer 1001", new List<string>()), new List<InvoiceLine>());
