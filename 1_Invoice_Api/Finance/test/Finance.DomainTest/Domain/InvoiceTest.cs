...
namespace Finance.DomainTest.Domain
{
    ...
    public sealed class InvoiceTest
    {
        ...
        public void Constructor_should_assign_InvoiceDate()
        {
            ...
            // Act
            var actual = new Invoice("1", invoiceDate, dueDate, null, null).InvoiceDate;
        ...
        public void Constructor_should_assign_DueDate()
        {
            ...
            // Act
            var actual = new Invoice("1", invoiceDate, dueDate, null, null).DueDate;
        ...
        public void Constuctor_should_assign_Lines()
        {
            ...
            // Act
            var actual = new Invoice("1", invoiceDate, dueDate, null, lines).Lines;
        ...
        public void SubTotal_should_be_the_sum_of_lines()
        {
            ...
            // Act
            var actual = new Invoice("1", invoiceDate, dueDate, null, lines).SubTotal;
